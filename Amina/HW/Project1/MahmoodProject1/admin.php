<?php
    ...
    */
    ...
    if(isset($_GET['deleteVenue']) && !($_GET['id'] == 1)){
        $db->adminDelete("venue", $_GET['id'], "idvenue");
        $db->adminDelete("event", $_GET['id'], "venue");
    }
        ...
        <div class="section container m9 s9">
            ...
            <?php
                ...
                foreach($result as $response){
                    ...
                    $result = $db->getRegisteredEvents($response["idattendee"]);
                    ...
                    $result2 = $db->getRegisteredSessions($response["idattendee"]);
